      ...
      <div className="w-full max-w-7xl flex flex-col gap-8 relative z-10">
        <div>
          <h1 className="text-3xl font-bold mb-2">
             <ShinyText text="Orchestrator" disabled={false} speed={2} className="text-[#f8fafc]" />
          </h1>
          <p className="text-gray-400 text-sm">
            Configure agent workflows and decision logic.
          </p>
        </div>
        ...
        <div className="p-12 rounded-2xl bg-[#080d1a] border border-[#1e293b] flex flex-col items-center justify-center relative overflow-hidden shadow-xl min-h-[400px]">
           ...
           <h2 className="text-2xl font-bold mb-2 z-10">
             <ShinyText text="Workflow Architecture" disabled={false} speed={2.5} className="text-gray-200" />
           </h2>
           <p className="text-gray-400 max-w-md text-center z-10">
             The orchestration engine seamlessly delegates tasks between the vision, data, and search agents to compute final CAM reports.
           </p>
        </div>
      </div>
    </div>
